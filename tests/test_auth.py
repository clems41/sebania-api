...
class AuthTestCase(APITransactionTestCase):
    fixtures = ["activite_default", "culture_default", "methode_agricole", "type_parcelle", "unite"]
    ...
    def test_register_ok(self):
        ...
        # verification de la création du responsable
        ...
        # verification de la création des employés
