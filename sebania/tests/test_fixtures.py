...
def create_tache(ferme: Ferme,  user_id: int, nb_parcelles: int = 2, date: datetime = timezone.now()) -> Tache:
    tache = Tache.objects.create(ferme=ferme, date=date, user_id=user_id, activite_id=3, duree_minutes=90,
